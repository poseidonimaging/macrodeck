...
class EventsController < ApplicationController
	...
	if !params[:q].nil?
	    ...
	    @events = Event.view("by_path_without_place_alpha", :reduce => false, :startkey => startkey, :endkey => endkey, :limit => 10, :skip => @start_item)
	    count_query = Event.view("by_path_without_place_alpha", :reduce => true, :group => true, :group_level => 4, :startkey => startkey, :endkey => endkey)
